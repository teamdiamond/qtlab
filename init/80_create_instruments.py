...
AWG = qt.instruments.create('AWG', 'Tektronix_AWG5014_09',
        address='TCPIP0::192.168.0.199::inst0::INSTR',reset=False,numpoints=1e3)
        #GPIB::23::INSTR' $#AWG = qt.instruments.create('AWG', 'Tektronix_AWG5014_09',
#        address='GPIB::23::INSTR',reset=False,numpoints=1e3)
# # Previous MW source, now at lt4 
# SMB100 = qt.instruments.create('SMB100', 'RS_SMB100',
#          address='USB0::0x0AAD::0x005F::258299::INSTR', reset=False, max_cw_pwr=-3)

# print 'SGS100A is being created now'
# SGS100A = qt.instruments.create('SGS100A', 'RS_SGS100A',
#         address='TCPIP0::192.168.0.33', reset=False)
